...
export function Hero() {
  return (
    <section className="bg-white dark:bg-gray-900" aria-labelledby="hero-title">
      <AuroraBackground>
        <div className="container-responsive py-16 sm:py-24 flex flex-col items-start gap-6">
          <h1 id="hero-title" className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
